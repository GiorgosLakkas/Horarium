...
public class Shift2 {
    ...
    // Constructor
    public Shift2(String employeeName, LocalDate date, LocalTime startTime, LocalTime endTime) {
    ...
    // 
    public static Shift2 createShift(String employeeName, LocalDate d, LocalTime s, LocalTime e) {

        LocalDate date = d;
        LocalTime start = s;
        LocalTime end = e;

        return new Shift2(employeeName, date, start, end);
    }
