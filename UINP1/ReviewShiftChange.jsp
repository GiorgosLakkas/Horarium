        ...
        <li>
          <details open>
            ...
            <ul class="menu" style="padding-left: 10px;">
              <li><a href="ReviewShiftChange.html" class="active"><i class="fa-solid fa-arrows-rotate"></i> Review Shift Change Request</a></li>
    ...
    <main class="main-content">
      <header class="header">
        <div class="profile-section">
          ...
          <h1>Review Shift Change Requests for <span id="employeeName">Manager</span></h1>
        </div>
      </header>
